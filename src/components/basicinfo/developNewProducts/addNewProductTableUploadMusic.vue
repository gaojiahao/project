 ...
 * @LastEditors: sueRimn
 * @LastEditTime: 2020-12-04 15:56:21
-->
<template>
<div>
    <div>
        <div style="height:28px">
            <div style="float:left;font-size: 16px;">
                <Icon type="md-musical-notes" />商品音乐
            </div>
        </div>
        <div style="width:100%">
            ...
            <Upload ref="upload" :show-upload-list="false" :default-file-list="defaultList" :on-success="handleSuccess" :format="['mp3']" :max-size="10240" :on-format-error="handleFormatError" :on-exceeded-size="handleMaxSize" :before-upload="handleBeforeUpload" multiple type="drag" action="//jsonplaceholder.typicode.com/posts/" style="display: inline-block;width:78px;">
                <div style="width: 120px;height:120px;line-height: 120px;">
                    <Icon type="md-musical-notes" size="30"></Icon>
                </div>
            </Upload>
