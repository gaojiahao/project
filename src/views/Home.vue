 ...
 * @LastEditors: sueRimn
 * @LastEditTime: 2020-10-23 15:44:46
-->
<template>
  <div class="layout">
    <Layout>
      ...
      <Layout class="container">
        ...
        <div
          :class="[isCollapsed ? 'marginRight' : 'marginLeft']"
          class="content"
        >
          <div class="content-panel">
            ...
            <div>
              <div
                style="display: flex;flex-direction:row;flex-wrap: nowrap;justify-content: flex-start; width: 100%;"
              >
                <Card
                  style="margin: 10px 10px;width:300px;background-color: #c1cbd7; height: 750px;"
                >
                  <TestTree></TestTree>
                </Card>
                <div>
                  <Card
                    style="margin: 10px 10px;width:600px;background-color: #c1cbd7;"
                  >
                    <TestForm></TestForm>
                  </Card>
                  <Card
