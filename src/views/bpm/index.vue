...
<div class="bpm-container">
    <div class="bpm-container-panel">
        <div class="left">
            <FlowList :list="List" @select-item="selectItem" @add="add"></FlowList>
        </div>
        <div class="right">
...
import FlowList from '@components/bpm/flowList'
...
export default {
    ...
    created() {
        this.nodeList = this.List[this.index].nodeList;
        this.linkList = this.List[this.index].linkList;
    },
    methods: {
