 ...
 * @LastEditTime: 2020-11-24 20:01:13
-->
<template>
<div>
            ...
            <div style="height:40px;width:100%;padding:10px">
                <div style="float:left">
                    ...
                    <RadioGroup v-model="platForm">
                        <Radio label="店铺1" border></Radio>
                        <Radio label="店铺2" border></Radio>
                        <Radio label="店铺3" border></Radio>
                    </RadioGroup>
                </div>
            </div>
            <ViewForm :formValidate="formValidate2" :ruleValidate="ruleValidate2" :formConfig="formConfig2">
                <template slot="button">
                    <FormItem>
                        <div style="width:100%">
...
import config2 from "@views/examine/selectionExamine/viewSelectionExamineConfig";
